    ...
    <div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-5 w-70">
        ...
        <div className="flex gap-2">
          <button onClick={handleClick} className="bg-[#80B500] text-white px-4 py-2 rounded-md hover:bg-green-700 flex-1">
            Buy Now
          </button>
          <button className="border border-[#80B500] text-[#80B500] px-4 py-2 rounded-md hover:bg-green-50 flex-1">
            Add to cart
          </button>
        </div>
      </div>
